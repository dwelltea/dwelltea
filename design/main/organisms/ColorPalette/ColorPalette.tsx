...
export function ColorPalette() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h3 className="mb-4 text-xl font-semibold text-gray-900">Primary Green</h3>
      ...
      <div>
        <h3 className="mb-4 text-xl font-semibold text-gray-900">Accent Gold</h3>
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
      ...
      <div>
        <h3 className="mb-4 text-xl font-semibold text-gray-900">Neutrals</h3>
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">

...
export function Button({
  ...
  const variantStyles = {
    primary: `
      ...
      active:bg-green-900 active:translate-y-0
      focus-visible:outline focus-visible:outline-2 focus-visible:outline-green-700 focus-visible:outline-offset-2
      disabled:bg-gray-300 disabled:text-gray-400 disabled:cursor-not-allowed disabled:opacity-60 disabled:hover:translate-y-0
    `,
    secondary: `
      bg-white text-green-700 border border-green-700
      hover:bg-gray-50 hover:border-green-800
      active:bg-gray-100
      focus-visible:outline focus-visible:outline-2 focus-visible:outline-green-700 focus-visible:outline-offset-2
      disabled:bg-white disabled:text-gray-400 disabled:border-gray-300 disabled:cursor-not-allowed disabled:opacity-60
    `,
    tertiary: `
      bg-transparent text-gray-800
      hover:text-green-700 hover:underline
      active:text-green-800
      focus-visible:outline focus-visible:outline-2 focus-visible:outline-green-700 focus-visible:outline-offset-2 focus-visible:rounded
      disabled:text-gray-400 disabled:cursor-not-allowed disabled:no-underline
    `
  };

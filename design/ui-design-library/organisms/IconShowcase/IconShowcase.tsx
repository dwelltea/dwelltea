...
function IconDisplay({ icon, name, size = 32, color }: IconDisplayProps) {
  return (
    <div className="flex flex-col items-center gap-2 p-4 bg-white rounded-lg border border-gray-200 hover:border-gold-600 transition-colors">
      <div className="flex items-center justify-center w-16 h-16 rounded-lg bg-cream-100" style={{ color }}>
        {icon}
      </div>
...
export function IconShowcase() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h3 className="mb-4 text-xl font-semibold text-gray-900">Navigation Icons (20px)</h3>
      ...
      <div>
        <h3 className="mb-4 text-xl font-semibold text-gray-900">Feature Icons (40px)</h3>
      ...
      <div>
        <h3 className="mb-4 text-xl font-semibold text-gray-900">Content Icons (32px)</h3>
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
